...
public class QuestionValidator {
     ...
     *
     * This method checks whether the {@code title} and {@code description} of the provided
     * {@link Question} are non-null and non-empty. It returns {@code true} if both fields are valid,
     * otherwise it returns {@code false}.
     *
     * @param question the {@link Question} entity to be validated.
     * @return {@code true} if the {@link Question} is valid, {@code false} otherwise.
     */
