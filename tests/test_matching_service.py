...
def delete_account(access_token: str, user_id: str):
    resp = requests.delete(f"{USER_SERVICE_ENDPOINT}users/{user_id}", 
...
def test_match_users_same_criteria(two_users):
    ...
    payload1["difficulty"] = "Easy"  # Change this to ensure this and the next request don't match
    payload1["topic"] = "Nonsense"  # Change this to ensure this and the next request don't match
