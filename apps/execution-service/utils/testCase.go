...
//func GetTestLengthAndExecutedCases(code string, testCase string) (int, []models.IndividualTestResult, error) {
//	lines := strings.Split(strings.TrimSpace(testCase), "\n")
//	if len(lines) < 1 {
//		return 0, nil, fmt.Errorf("test case format is incorrect, no lines found")
//	}
...
//	var testResults []models.IndividualTestResult
//	for i := 1; i < len(lines); i += 2 {
//		// execute code dynamically with input, and compare output with expected
//
//	}
//
//	numCases, testResults, err := GetTestLengthAndUnexecutedCases(testCase)
//	if err != nil {
//		return 0, nil, err
//	}
//
