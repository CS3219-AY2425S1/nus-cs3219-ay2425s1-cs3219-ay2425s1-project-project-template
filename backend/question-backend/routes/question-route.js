...
import { createQuestion, deleteQuestion, updateQuestion, getAllQuestions, getQuestionById, getQuestionByTopicAndDifficulty } from "../controllers/question-controller.js";
...
router.get("/search", verifyAccessToken, getQuestionByTopicAndDifficulty);
