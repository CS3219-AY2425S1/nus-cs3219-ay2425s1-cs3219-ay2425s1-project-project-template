...
//Test
// setTimeout(() => { handleMatchRequest({ id: 'Testing one', category: 'array', difficulty: 'easy' });}, 20000)
// setTimeout(() => { handleMatchRequest({ id: 'Testing two', category: 'array', difficulty: 'easy' });}, 25000)