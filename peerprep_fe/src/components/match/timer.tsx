    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            ...
            <div className='relative mb-6'>
                <svg width="200" height="200" className='mb-4'> {/* Increased size of SVG */}
                    <circle cx="100" cy="100" r={radius} stroke="white" strokeWidth="5" fill="none" />
                    <circle 
                        cx="100" 
                        cy="100" 
                        r={radius} 
            ...
            {time < duration && (
                <div className='loader mb-4'>
                    <i className="fas fa-spinner fa-spin text-white text-2xl"></i> {/* Loading icon */}
                </div>
            )}
        </div>
    );
