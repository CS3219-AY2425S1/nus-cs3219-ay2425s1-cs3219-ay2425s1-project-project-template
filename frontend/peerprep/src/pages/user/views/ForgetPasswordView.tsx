...
const ForgotPasswordView: React.FC<ForgotPasswordViewProps> = ({ onSubmit, onReturnToLogin, errorMessage }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-br from-[#1D004E] to-[#141A67]">
      ...
      <div className="bg-white bg-opacity-10 p-8 md:p-10 rounded-lg backdrop-blur-md text-center w-[400px] max-w-full mx-auto">
        ...
        <p className="text-white mt-2 mb-5 text-sm">We will send a password reset link to your email.</p>
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          />
          <LargeButton text="Send Reset Link" onClick={handleSubmit} />
        </form>
        {errorMessage && (
