    ...
    return (
        <>
            <div className="flex flex-[4] m-6 ml-12">
                <Tabs defaultValue="profile" className="box w-full space-y-10">
                    <div className="flex flex-row">
                        <TabsList className="flex justify-start relative border-b border-gray-300 bg-transparent rounded-none w-full p-0 m-1">
