        ...
        <section className="bg-violet-800 h-screen flex items-center justify-start 2xl:justify-center pl-28">
            <div className="text-center 2xl:w-3/5">
                ...
                <div className="flex justify-start">
                    <button className="mt-6 px-8 py-3 mr-4 bg-yellow-500 text-white font-bold rounded-lg">
                        Get Started
                    </button>
                    <button className="mt-6 px-8 py-3 bg-violet-800 text-yellow-500 border border-yellow-500 font-bold rounded-lg">
                        Find out more
                    </button>
                </div>
            </div>
