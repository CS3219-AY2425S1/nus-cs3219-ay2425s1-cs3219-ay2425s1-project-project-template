...
const NEXT_PUBLIC_IAM_USER_SERVICE = "https://user-service-598285527681.us-central1.run.app/api/iam/auth";

const NEXT_PUBLIC_IAM_AUTH_SERVICE = "https://user-service-598285527681.us-central1.run.app/api/iam/users";
