...
const Header = () => {
  return (
    <header className="w-full flex sticky top-0 z-10 items-center justify-between border border-x-0 border-b border-t-0 border-gray-300/20 px-6 py-4">
      ...
      <div className="flex items-center space-x-4">
        ...
        <button className="flex flex-row items-center rounded-full border border-gray-300/30">
          <img
            src="/images/man.gif"
            alt="PeerPrep logo"
